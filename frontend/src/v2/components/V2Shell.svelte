  ...
  <div class="v2-app">
    <aside class="v2-sidebar">
      ...
      <div class="v2-demo-controls">
        ...
        {:else}
          <button class="v2-demo-reset-button" type="button" onclick={()=>resetConfirming=true}><RotateCcw size={15}/><span>Reset demo data</span></button>
        {/if}
      </div>
