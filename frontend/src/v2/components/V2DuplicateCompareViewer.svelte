<script lang="ts">
  ...
  import { comparisonMemberData, formatSimilarityPercent, similarityValidatedDimensions, usesBoundedValidation, type ComparisonMemberData } from '../data/duplicateMember';
