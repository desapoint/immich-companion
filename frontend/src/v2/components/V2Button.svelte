...
<button class="v2-button" data-variant={variant} data-active={active || undefined} data-block={block || undefined} data-icon-only={iconOnly || undefined} {disabled} {type} {title} aria-label={ariaLabel} {onclick}>
  {@render children()}
</button>
