...
function resource(url: string, asset: MediaAsset, delivery: MediaResource['delivery'], posterUrl: string | null = null): MediaResource { return { url, fallbackUrls: [], mimeType: mimeForUrl(url, asset.original_mime_type), posterUrl, delivery, originalMimeType: asset.original_mime_type, expiresAt: null }; }
