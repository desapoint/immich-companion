...
function normalizeTrashDetail(asset:ApiAssetDetail):TrashAssetRecord{return{id:asset.id,type:(['IMAGE','VIDEO','AUDIO'].includes(asset.type)?asset.type:'OTHER') as TrashAssetRecord['type'],original_file_name:asset.original_file_name,original_mime_type:asset.original_mime_type,width:asset.width,height:asset.height,duration:asset.duration,taken_at:asset.taken_at,file_modified_at:asset.file_modified_at,is_favorite:asset.is_favorite,is_archived:asset.is_archived,restore_path:asset.original_path}}
