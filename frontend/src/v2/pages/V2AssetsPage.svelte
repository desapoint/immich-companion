...
<V2PageLayout title="Assets" description="Search, browse, select, synchronize and perform guarded actions on assets.">
  ...
  {#snippet inspector()}
    <V2Zone>
      {#if tab==='Browse'}
        <V2Section title="Active search"><V2Card><span class="v2-small">{summary}</span></V2Card></V2Section><V2Section title="Selection"><V2Card><V2Stack gap="sm"><b>3 assets selected</b><span class="v2-small v2-muted">Resolved selection summary and applicable actions.</span></V2Stack></V2Card></V2Section><V2Section title="Actions"><V2Stack gap="sm"><V2Button>Add to album</V2Button><V2Button>Favorite</V2Button><V2Button>Archive</V2Button><V2Button>Stack</V2Button><V2Button>Add tags</V2Button><V2Button variant="danger">Move to trash</V2Button></V2Stack></V2Section>
      {:else}
        <V2Section title="Selected saved search"><V2Card><V2Stack gap="sm"><b>{selectedSaved}</b><span class="v2-small v2-muted">Saved-search editing and persistence are demo-only for now.</span><V2Button onclick={()=>{loadSaved(selectedSaved);tab='Browse';searchMode='Expert'}}>Open search</V2Button></V2Stack></V2Card></V2Section>
      {/if}
    </V2Zone>
  {/snippet}
</V2PageLayout>
