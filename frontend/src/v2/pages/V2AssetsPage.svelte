<script lang="ts">
  ...
  function clearSelection(){capabilityRequests.cancel();removableRelations.cancel();selection=emptyAssetSelection<string>();moreOpen=false;removeRelationDialog=null;selectionCapabilities=emptyCapabilities();selectionError=''}
