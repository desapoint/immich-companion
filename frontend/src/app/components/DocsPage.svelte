<script lang="ts">
  ...
  import V2Menu from '../../lib/components/ui/Menu.svelte';
...
<V2PageLayout title="API Docs" description="Browse the Companion endpoints and schemas used by the current integration.">
