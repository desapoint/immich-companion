<script lang="ts">
  ...
  function visibleRunCounters(counters: Record<string, number>) { return Object.entries(counters).filter(([name]) => !name.startsWith('telemetry__')); }
...
{:else}<V2Stack gap="md">
  ...
  <V2Section title="Performance history"><SyncHistorySection /></V2Section>
