<script lang="ts">
  ...
  import DuplicateAutomationRulesEditor from './DuplicateAutomationRulesEditor.svelte';
  import DuplicateKeeperPriorityEditor from './DuplicateKeeperPriorityEditor.svelte';
  import type {
    DuplicateDecision,
