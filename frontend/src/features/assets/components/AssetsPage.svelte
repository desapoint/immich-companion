<script lang="ts">
  ...
  import V2AssetRelationModal from './AssetRelationModal.svelte';
  import V2AssetRelationRemoveModal from './AssetRelationRemoveModal.svelte';
  import V2AssetSearchDrawer from './AssetSearchDrawer.svelte';
  ...
  import V2SavedSearchLibrary from './SavedSearchLibrary.svelte';
  import V2SavedSearchModal from './SavedSearchModal.svelte';
  import V2SearchSelectionDialog from './SearchSelectionDialog.svelte';
  import V2Section from '../../../lib/components/layout/Section.svelte';
  import V2Segmented from '../../../lib/components/ui/Segmented.svelte';
  import V2SimpleAdvancedFilters from './SimpleAdvancedFilters.svelte';
  import V2StackActionModal from './StackActionModal.svelte';
  ...
  import { applyShiftAssetRange,isAllVisibleSelected,isAssetSelected,resolveAssetSelectionPrimary,toggleAssetSelected } from '../state/assetSelection';
  ...
  import type { AssetRecord, AssetSearchCriteria, AssetSearchQuery, AssetSelectionCapabilities, AssetSelectionTarget, SavedSearchRecord, StackActionPlan, StackResolution, ViewerNavigationWindow } from '../../../lib/types/libraryContracts';
...
<V2PageLayout title="Assets" description="Find, review, and organize assets from the active data source.">
...
<style>:global(.v2-selection-toolbar .v2-toolbar-group){flex-wrap:wrap}:global([data-page-title='Assets'] .v2-context .v2-zone-body>.v2-inline){flex-wrap:wrap!important;border-top:1px solid var(--v2-line);padding-top:var(--v2-space-4);margin-top:0}:global([data-page-title='Assets'] .v2-context .v2-zone-body>.v2-inline>.v2-button:nth-child(1)){flex:1 1 0;width:auto}:global([data-page-title='Assets'] .v2-context .v2-zone-body>.v2-inline>.v2-button:nth-child(2)){flex:0 0 auto}:global([data-page-title='Assets'] .v2-context .v2-zone-body>.v2-inline>.v2-button:nth-child(3)){flex:1 1 100%;width:auto}.v2-asset-toolbar-action{display:inline-flex;align-items:center;gap:4px}.v2-asset-toolbar-label{display:none;color:var(--v2-muted);font-size:11px;font-weight:700}.v2-selection-more{position:relative}.v2-selection-menu{position:absolute;z-index:30;top:calc(100% + .4rem);right:0;min-width:14.5rem;display:grid;gap:.18rem;padding:.4rem;border:1px solid var(--v2-border,rgba(127,127,127,.32));border-radius:.65rem;background:var(--v2-surface,Canvas);box-shadow:0 .65rem 1.8rem rgba(0,0,0,.18)}.v2-selection-menu button{border:0;border-radius:.45rem;background:transparent;color:inherit;padding:.55rem .65rem;text-align:left;font:inherit;cursor:pointer;display:flex;align-items:center;gap:.6rem}.v2-selection-menu button:hover:not(:disabled){background:color-mix(in srgb,currentColor 8%,transparent)}.v2-selection-menu button:disabled{opacity:.42;cursor:not-allowed}.v2-selection-menu-separator{height:1px;background:var(--v2-border,rgba(127,127,127,.28));margin:.25rem 0}.v2-selection-menu-label{padding:.35rem .65rem .15rem;font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;opacity:.62}@media(max-width:380px){.v2-asset-toolbar-label{display:inline}}</style>
