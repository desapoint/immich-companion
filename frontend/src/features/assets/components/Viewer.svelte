<script lang="ts">
  import V2AssetViewer from './AssetViewer.svelte';
  import V2RestoreViewer from './RestoreViewer.svelte';
  import type { ViewerNavigationWindow } from '../../../lib/types/libraryContracts';
