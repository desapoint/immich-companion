<script lang="ts">
  ...
  import V2RelationFilterField from '../../assets/components/RelationFilterField.svelte';
  ...
  import V2TaskBubble from '../../status/components/TaskBubble.svelte';
  import V2Toggle from '../../../lib/components/ui/Toggle.svelte';
  import V2Toolbar from '../../../lib/components/layout/Toolbar.svelte';
  import V2VideoPlayer from '../../assets/components/VideoPlayer.svelte';
      ...
      <V2Card title="Relation filter">
        <V2Stack gap="sm">
          <V2RelationFilterField
            ...
            onvalueschange={(values: string[]) => relationValues = values}
            onemptychange={(selected: boolean) => relationEmpty = selected}
          />
